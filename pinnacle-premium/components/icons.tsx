...
// Using Lucide-react style props
export interface IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
}

export const BitcoinIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M11.767 19.089c4.924-2.12 7.791-7.12 7.182-11.944a7.436 7.436 0 0 0-2.334-4.302 7.433 7.433 0 0 0-4.302-2.334c-4.825-.609-9.825 2.258-11.945 7.182-2.12 4.924-.426 10.233 4.302 12.565a10.723 10.723 0 0 0 7.097 0Z"/><path d="M8.5 7.455v9.1m-2.25-6.832h4.5m-4.5 4.564h4.5m1.5-6.832v9.1M13 10.222h2.25m-2.25 4.565h2.25M9 18.055v1.25m2 0v-1.25m2 0v1.25m2 0v-1.25"/></svg>
);
...
export const GemIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M6 3h12l4 6-10 13L2 9Z"/><path d="M12 22V9"/><path d="m3.5 8.5 8.5 4 8.5-4"/><path d="M2.17 8.5 12 22l9.83-13.5"/></svg>
);
...
export const PaletteIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="13.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="10.5" r=".5" fill="currentColor"/><circle cx="8.5" cy="7.5" r=".5" fill="currentColor"/><circle cx="6.5" cy="12.5" r=".5" fill="currentColor"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.47-1.125-.29-.289-.69-.47-1.128-.47H10c-.55 0-1-.45-1-1v-1a1 1 0 0 1 1-1h6a1 1 0 0 0 1-1v-1a1 1 0 0 0-1-1h-1a1 1 0 0 0-1-1H9a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h3a1 1 0 0 1 1 1v1c.55 0 1 .45 1 1h.5a2.5 2.5 0 0 0 2.5-2.5V3c0-.55-.45-1-1-1h-1z"/></svg>
);

export const MiningIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M10 22a2 2 0 0 1-2-2v-5l-5-2 1-4 4 1 3-3 4 1-2 5v5a2 2 0 0 1-2 2h-1Z"/><path d="m14 13-3-3 1-4 4 1-2 5Z"/><path d="m4 11 4 1"/><path d="m18.5 4.5-3 3"/></svg>
);
...
export const BriefcaseBusinessIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 12h.01"/><path d="M16 6V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/><path d="M22 13a10 10 0 1 1-20 0"/><rect width="20" height="14" x="2" y="6" rx="2"/></svg>
);
...
export const HeartHandshakeIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/><path d="M12 5 9.04 7.96a2.17 2.17 0 0 0 0 3.08v0c.82.82 2.13.82 2.94 0l.02-.02 2.92-2.92c.82-.82.82-2.13 0-2.94v0A2.17 2.17 0 0 0 12 5Z"/></svg>
);

export const TwitterIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M22 4s-.7 2.1-2 3.4c1.6 1.4 3.3 4.4 3.3 4.4s-1.4-.6-2.8-.9c-1.4 2.6-4.4 4.1-4.4 4.1s-1.5-.9-2.8-2.6c-2.3 1.1-4.8 2.2-4.8 2.2s-1.6-1.1-2.8-2.5c-.8.2-2.3.6-2.3.6s-1.4-1.9-2.8-4.4c.5.2 1.1.4 1.1.4s-.5-1.1-.9-2.8C2 10.3 4.1 8 4.1 8s1.6.9 2.8 1.4C7.7 6.3 12 4 12 4s1.9.4 3.3 1.4c1.4-1.1 2.8-1.4 2.8-1.4z"/></svg>
);
...
export const TelegramIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M22 2 11 13l-4 9 9-4 6-16Z"/><path d="M22 2 11 13"/></svg>
);

export const RocketIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.3.5-3.5-1.17-1.17-2.66-.99-3.5-.5z"/><path d="m12 15-3-3a9 9 0 0 1 3-13v7c0 .55.45 1 1 1h7a9 9 0 0 1-13 3z"/><path d="M15 12H9"/><path d="M17.5 14.5c1.5-1.26 2-5 2-5s-3.74.5-5 2c-.71.84-.7 2.3-.5 3.5 1.17 1.17 2.66.99 3.5.5z"/></svg>
);

export const LeafIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M11 20A7 7 0 0 1 4 13V8a5 5 0 0 1 10 0v5a7 7 0 0 1-7 7m0 0v-5"/><path d="M12 12a5 5 0 0 0 5-5V3"/></svg>
);
...
export const ArrowUpFromLineIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M18 9V4h-6"/><path d="m6 9 6-6 6 6"/><path d="M12 3v13"/><path d="M3 21h18"/></svg>
);

export const ArrowDownToLineIcon: React.FC<IconProps> = (props) => (
...
export const WalletIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M19 7V4a1 1 0 0 0-1-1H5a2 2 0 0 0 0 4h15a1 1 0 0 1 1 1v4h-3a2 2 0 0 0 0 4h3v1a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h14"/><path d="M18 12.5a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1Z"/></svg>
);
